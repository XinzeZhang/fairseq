...
BPEROOT=data-src/translation/subword-nmt/subword_nmt
BPE_TOKENS=60000
...
lang=cn-en
task=forward.bpe
bpe=data-src/ldc/$task
word=data-src/ldc/$task/word
...
for l in $src $tgt; do
    raw=data-src/ldc/ldc_raw/train.cn-en.$l
